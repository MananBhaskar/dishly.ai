...
import { getCategoryEmoji, getCountryFlag, getSupportedCountries } from "@/lib/data";
...
const DashboardPage = async () => {
  ...
  const areas = (areasData?.areas || []).filter((area) =>
    supportedCountries.includes(area.strArea)
  );
      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-orange-600 hover-shadow-lg transition-all duration-300 group cursor-pointer">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <Button variant="primary" size="lg" className="bg-orange-600 hover:bg-orange-700 text-white font-bold ">
        ...
        <section className="mt-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            {categories.map((category) => (
              ...
              href={`/recipes/category/${category.strCategory.toLowerCase().replace(/\s+/g, "-")}`}
              >
        ...
        <section className="mt-24">
          <div className="mb-8">
            ...
            <p className="text-stone-600 text-lg font-light">
              Travel the globe through your taste buds
            </p>
          </div>
            ...
            {areas.map((area) => (
              ...
              >
                <div className="bg-stone-50 p-5 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all group cursor-pointer">
                  ...
                  <span className="font-bold text-sm text-stone-900 group-hover:text-orange-600 transition-colors">
                    {area.strArea}
                  </span>
                  </div>
                </div>
