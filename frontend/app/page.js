            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <Link href={'/dashboard'}>
                <Button
                  size="xl"
                  variant="primary"
                  className="px-8 py-4 text-lg bg-orange-600 text-white hover:bg-orange-700 transition-colors duration-300">
              ...
              return (
                <div key={i}>
                  <div className="flex gap-6 items-start">
                    <Badge
                      variant="outline"
                      className="text-6xl font-bold border-none text-orange-500 bg-transparent h-auto p-0"
                    >
                      {item.step}
                    </Badge>
                  ...
                  {i < HOW_IT_WORKS_STEPS.length - 1 && (
                    <hr className="my-8 bg-stone-700"></hr>
                  )}
                </div>
              );
            })}
